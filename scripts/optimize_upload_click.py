...
if old not in s: raise SystemExit('page observer block not found')
...
if old not in s: raise SystemExit('upload prefix not found')
s=s.replace(old,new,1)
...
p.write_text(s)
print('optimized upload and interaction')
